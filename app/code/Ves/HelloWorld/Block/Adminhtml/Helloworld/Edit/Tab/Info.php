...
namespace Ves\HelloWorld\Block\Adminhtml\Helloworld\Edit\Tab;
   ...
   /**
    ...
    protected function _prepareForm()
    {
       /** @var $model \Tutorial\SimpleNews\Model\News */
        $model = $this->_coreRegistry->registry('ves_helloworld');
 
        /** @var \Magento\Framework\Data\Form $form */
        $form = $this->_formFactory->create();
        $form->setHtmlIdPrefix('helloworld_');
        $form->setFieldNameSuffix('helloworld');

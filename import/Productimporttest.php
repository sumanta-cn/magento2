...
$product->setCategoryIds($row[4]);
$product->setTaxClassIds($row[11]); // Tax class id
...
$product->addImageToMediaGallery('/catalog/product'.$row[21], array('image','thumbnail','small_image'), false, false); //assigning image, thumb and small image to media gallery
